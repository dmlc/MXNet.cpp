 ...
 * \return new symbol
 */
inline Symbol abs(const std::string& symbol_name, Symbol src) {
  return Operator("abs").SetInput("src", src).CreateSymbol(symbol_name);
}
 ...
 * \return new symbol
 */
inline Symbol sign(const std::string& symbol_name, Symbol src) {
  return Operator("sign").SetInput("src", src).CreateSymbol(symbol_name);
}
 ...
 * \return new symbol
 */
inline Symbol round(const std::string& symbol_name, Symbol src) {
  return Operator("round").SetInput("src", src).CreateSymbol(symbol_name);
}
 ...
 * \return new symbol
 */
inline Symbol ceil(const std::string& symbol_name, Symbol src) {
  return Operator("ceil").SetInput("src", src).CreateSymbol(symbol_name);
}
 ...
 * \return new symbol
 */
inline Symbol floor(const std::string& symbol_name, Symbol src) {
  return Operator("floor").SetInput("src", src).CreateSymbol(symbol_name);
}
 ...
 * \return new symbol
 */
inline Symbol square(const std::string& symbol_name, Symbol src) {
  return Operator("square").SetInput("src", src).CreateSymbol(symbol_name);
}
 ...
 * \return new symbol
 */
inline Symbol sqrt(const std::string& symbol_name, Symbol src) {
  return Operator("sqrt").SetInput("src", src).CreateSymbol(symbol_name);
}
 ...
 * \return new symbol
 */
inline Symbol rsqrt(const std::string& symbol_name, Symbol src) {
  return Operator("rsqrt").SetInput("src", src).CreateSymbol(symbol_name);
}
 ...
 * \return new symbol
 */
inline Symbol exp(const std::string& symbol_name, Symbol src) {
  return Operator("exp").SetInput("src", src).CreateSymbol(symbol_name);
}
 ...
 * \return new symbol
 */
inline Symbol log(const std::string& symbol_name, Symbol src) {
  return Operator("log").SetInput("src", src).CreateSymbol(symbol_name);
}
 ...
 * \return new symbol
 */
inline Symbol cos(const std::string& symbol_name, Symbol src) {
  return Operator("cos").SetInput("src", src).CreateSymbol(symbol_name);
}
 ...
 * \return new symbol
 */
inline Symbol sin(const std::string& symbol_name, Symbol src) {
  return Operator("sin").SetInput("src", src).CreateSymbol(symbol_name);
}
 ...
 *        to thesame size. For bilinear upsampling this must be 2; 1 input and 1
 * weight.
...
inline Symbol UpSampling(const std::string& symbol_name,
                         const std::vector<Symbol>& data, int scale,
                         UpSamplingSampleType sample_type, int num_args,
                         int num_filter = 0,
                         UpSamplingMultiInputMode multi_input_mode =
                             UpSamplingMultiInputMode::concat) {
  static const char* UpSamplingSampleTypeValues[] = {"bilinear", "nearest"};
  static const char* UpSamplingMultiInputModeValues[] = {"concat", "sum"};
  return Operator("UpSampling")
      ...
      .SetParam("multi_input_mode",
                UpSamplingMultiInputModeValues[static_cast<int>(multi_input_mode)])(data)
 ...
 * \return new symbol
 */
inline Symbol SwapAxis(const std::string& symbol_name, Symbol data,
 ...
 * \return new symbol
 */
inline Symbol SoftmaxOutput(const std::string& symbol_name, Symbol data,
 ...
 * \return new symbol
 */
inline Symbol Softmax(const std::string& symbol_name, Symbol data,
                      mx_float grad_scale = 1, mx_float ignore_label = -1,
                      bool multi_output = false, bool use_ignore = false) {
 ...
 * \return new symbol
 */
inline Symbol SoftmaxActivation(const std::string& symbol_name, Symbol data,
                                SoftmaxActivationType type =
                                    SoftmaxActivationType::instance) {
  static const char* SoftmaxActivationTypeValues[] = {"channel", "instance"};
 ...
 * \return new symbol
 */
inline Symbol SliceChannel(const std::string& symbol_name, int num_outputs,
                           int axis = 1, bool squeeze_axis = false) {
 ...
 * \return new symbol
 */
inline Symbol Reshape(const std::string& symbol_name, Symbol data,
                      Shape target_shape) {
 ...
 * \return new symbol
 */
inline Symbol Flatten(const std::string& symbol_name, Symbol data) {
  return Operator("Flatten").SetInput("data", data).CreateSymbol(symbol_name);
}
 ...
 * \return new symbol
 */
inline Symbol MAERegressionOutput(const std::string& symbol_name, Symbol data,
                                  Symbol label, mx_float grad_scale = 1) {
...
/*!
 * \breif Use Logistic regression for final output, this is used on final output
 * of a net.
 ...
 * \return new symbol
 */
inline Symbol Pooling(const std::string& symbol_name, Symbol data, Shape kernel,
                      PoolingPoolType pool_type, Shape stride = Shape(1, 1),
                      Shape pad = Shape(0, 0)) {
  static const char* PoolingPoolTypeValues[] = {"avg", "max", "sum"};
 ...
 * \return new symbol
 */
inline Symbol LRN(const std::string& symbol_name, Symbol data, int nsize,
                  mx_float alpha = 0.0001, mx_float beta = 0.75,
                  mx_float knorm = 2) {
  return Operator("LRN")
 ...
 * \return new symbol
 */
inline Symbol LeakyReLU(const std::string& symbol_name, Symbol data,
                        LeakyReLUActType act_type = LeakyReLUActType::leaky,
                        mx_float slope = 0.25, mx_float lower_bound = 0.125,
                        mx_float upper_bound = 0.334) {
  static const char* LeakyReLUActTypeValues[] = {"elu",   "leaky",
                                                 "prelu", "rrelu"};
 ...
 * \return new symbol
 */
inline Symbol FullyConnected(const std::string& symbol_name, Symbol data,
 ...
 * \return new symbol
 */
inline Symbol Embedding(const std::string& symbol_name, Symbol data,
                        Symbol weight, int input_dim, int output_dim) {
 ...
 * \return new symbol
 */
inline Symbol ElementWiseSum(const std::string& symbol_name, int num_args) {
  return Operator("ElementWiseSum").SetParam("num_args", num_args).CreateSymbol(
      symbol_name);
}
 ...
 * \return new symbol
 */
inline Symbol Dropout(const std::string& symbol_name, Symbol data,
                      mx_float p = 0.5) {
 ...
 * \return new symbol
 */
inline Symbol Deconvolution(const std::string& symbol_name, Symbol data,
                            Symbol weight, Symbol bias, Shape kernel,
                            int num_filter, Shape stride = Shape(1, 1),
                            Shape pad = Shape(0, 0), int num_group = 1,
                            int64_t workspace = 512, bool no_bias = true) {
 ...
 *        use the heightand width of the second input symbol, we name crop_like
 * here
 ...
 * \return new symbol
 */
inline Symbol Crop(const std::string& symbol_name, Symbol data, int num_args,
                   Shape offset = Shape(0, 0), Shape h_w = Shape(0, 0),
 ...
 *        num_group,apply convolution and concat instead to achieve the same
 * need.
 * \param workspace Tmp workspace for convolution (MB).
 * \param no_bias Whether to disable bias parameter.
 * \return new symbol
 */
inline Symbol Convolution(const std::string& symbol_name, Symbol data,
                          Symbol weight, Symbol bias, Shape kernel,
                          int num_filter, Shape stride = Shape(1, 1),
                          Shape dilate = Shape(1, 1), Shape pad = Shape(0, 0),
                          int num_group = 1, int64_t workspace = 512,
                          bool no_bias = false) {
...
inline Symbol Concat(const std::string& symbol_name,
                     const std::vector<Symbol>& data, int num_args,
                     int dim = 1) {
 ...
 * \return new symbol
 */
inline Symbol Cast(const std::string& symbol_name, Symbol data,
                   CastDtype dtype) {
  static const char* CastDtypeValues[] = {"float16", "float32", "float64",
                                          "int32",   "uint8"};
 ...
 * \return new symbol
 */
inline Symbol BlockGrad(const std::string& symbol_name, Symbol data) {
  return Operator("BlockGrad").SetInput("data", data).CreateSymbol(symbol_name);
}
 ...
 * \return new symbol
 */
inline Symbol BatchNorm(const std::string& symbol_name, Symbol data,
                        mx_float eps = 0.001, mx_float momentum = 0.9,
                        bool fix_gamma = true) {
...
inline Symbol Activation(const std::string& symbol_name, Symbol data,
  ...
  static const char* ActivationActTypeValues[] = {"relu",     "sigmoid",
                                                  "softrelu", "tanh"};
